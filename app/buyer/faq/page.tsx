      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Everything you need to know about buying agricultural products on
            FarmShare
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">
                  How does pool buying work?
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  Pool buying allows multiple buyers to purchase agricultural
                  products together to access wholesale prices. When you join a
                  pool, you're reserving a portion (slot) of the total product
                  quantity. Once all slots are filled and the pool is complete,
                  the vendor prepares and delivers the products to all buyers.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  ...
                  all buyers automatically receive a full refund to their
                  original payment method. You'll be notified via email, and no
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  We accept payments through Paystack and Stripe, supporting
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">
                  Can I choose the number of slots I want?
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  Yes! You can purchase multiple slots in a pool, up to a
                  maximum of 10 slots per order. Simply adjust the quantity
                  using the +/- buttons in the checkout modal, and the total
            ...
            <Card>
              ...
              <CardContent>
                ...
                <ul className="list-disc list-inside mt-2 space-y-1 text-muted-foreground">
                  <li>
                    <strong>Pickup:</strong> Collect your products from the
                    vendor's specified location at no additional cost
                  </li>
                  <li>
                    <strong>Home Delivery:</strong> Have products delivered to
                    your address for a small additional fee
                  </li>
                </ul>
                <p className="text-muted-foreground mt-2">
                  Delivery costs are shared among all buyers who choose home
                  delivery, making it more affordable for everyone.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Delivery timelines vary by product and vendor, but typically
                  range from 3-7 days after a pool fills. The exact delivery
                  timeframe is shown in each pool's details. You'll receive
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">
                  What if I'm not satisfied with the products?
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  We have a quality guarantee system. If you receive products
                  that don't match the description or quality standards:
                </p>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground mt-2">
                  Once a pool fills and the vendor begins preparation,
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground mt-2">
                  Pool prices typically represent 20-40% savings compared to
                  retail prices.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">
                  What fees does FarmShare charge?
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  FarmShare charges a small 2% platform fee on buyer
                  transactions. This fee is included in the total price shown
                  before you confirm your purchase. There are no hidden fees or
                  charges.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Chat with our support team for instant help with your
                  questions.
                </p>
        ...
        <Card className="bg-primary/5">
          <CardContent className="text-center py-8">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Join thousands of smart buyers who are saving money on quality
              agricultural products through FarmShare.
            </p>
            <Button
              asChild
              className="bg-accent hover:bg-accent/90 text-accent-foreground"
            >
              <Link href="/buyer/marketplace">Browse Available Pools</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
